...
export default function Dashboard() {
  ...
  const cards = [
    { icon: Users, title: '学生', count: '120 名', subtitle: '活跃', path: '/students' },
    { icon: FolderGit2, title: '项目', count: '25 个', subtitle: '进行中', path: '/projects' },
    { icon: FileText, title: '资源', count: '45 个', subtitle: '文件', path: '/resources' },
