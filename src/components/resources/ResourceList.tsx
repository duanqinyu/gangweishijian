...
const mockResources: Resource[] = [
  { id: '1', title: 'Course Syllabus', type: 'document', url: '/documents/syllabus.pdf', uploadedAt: new Date('2024-01-15') },
  { id: '2', title: 'Project Guidelines', type: 'document', url: '/documents/guidelines.pdf', uploadedAt: new Date('2024-01-20') },
  { id: '3', title: 'Learning Platform', type: 'link', url: 'https://learning.example.com', uploadedAt: new Date('2024-01-25') },
];
